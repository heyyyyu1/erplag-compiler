...
// Global variable definitions for parser
char **enumToTerminal = NULL;
char **enumToNonTerminal = NULL;
int **firstEquations = NULL;
int **followEquations = NULL;
Hashtable * hash_tb = NULL;
